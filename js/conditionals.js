...
function analyzeColor(nameOfColor){
    if(nameOfColor === 'red') {
       return "Strawberries are red."
        ...
        return "You have not picked a defined color."
    }
}
...
switch(analyzeColor) {
    ...
    break;
    default:
        alert("You have not picked a defined color");
        break;
}
...
function calculateTotal(luckyNumber,initialTotal){
    if(luckyNumber == 0) {
        return initialTotal
    } else if ( luckyNumber == 1) {
        return initialTotal -( .1 * initialTotal)
    } else if(luckyNumber == 2) {
        return initialTotal - ( .25 * initialTotal)
    } else if(luckyNumber == 3) {
        return initialTotal - ( .35 * initialTotal)
    } else if(luckyNumber == 4) {
        return initialTotal -  ( .5 * initialTotal)
